          ...
          <form id="new-employee-form" class="space-y-6">
            <div class="bg-background-secondary p-6 rounded-lg border border-border-color">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label for="employee_code" class="block text-sm font-medium text-text-secondary mb-2">Employee Code *</label>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                <div>
                  <label for="first_name" class="block text-sm font-medium text-text-secondary mb-2">First Name *</label>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                <div>
                  <label for="last_name" class="block text-sm font-medium text-text-secondary mb-2">Last Name *</label>
            ...
            <div class="bg-background-secondary p-6 rounded-lg border border-border-color">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label for="hire_date" class="block text-sm font-medium text-text-secondary mb-2">Hire Date *</label>
                ...
                <div>
                  <label for="role_id" class="block text-sm font-medium text-text-secondary mb-2">Role *</label>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                <div>
                  <label for="headquarters_id" class="block text-sm font-medium text-text-secondary mb-2">Headquarters *</label>
                ...
                <div>
                  <label for="status_id" class="block text-sm font-medium text-text-secondary mb-2">Status *</label>
